...
http://tvaira.free.fr/dev/cours/c%2B%2B-moderne-src.zip[c{plus}{plus}-moderne-src.zip]
...
ifdef::backend-html5[]
La version PDF de ce document : link:http://tvaira.free.fr/dev/cours/c%2B%2B-moderne.pdf[c{plus}{plus}-moderne.pdf].
endif::[]
